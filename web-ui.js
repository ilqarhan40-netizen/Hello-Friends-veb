...
// Назначение: Меню, Вкладки, Базовые модальные окна, Тема, Главный Профиль, Звонки, Поиск, Кошелек, Почта
// ==========================================
...
window.saveProfileData = function(btn) {
    ...
    const data = {
        ...
        about: document.getElementById('prof-about').value.trim() // Сохраняем "Обо мне"
    };
    if (window.firebase) {
