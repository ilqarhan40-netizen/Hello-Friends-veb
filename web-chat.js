// ==========================================
// ФАЙЛ: web-chat.js (ВОССТАНОВЛЕННЫЙ И РАБОЧИЙ)
// ==========================================
...
window.joinedRoomTime = Date.now(); 
...
window.startVrDictation = function() {
    ...
    recognition.onstart = function() {
        ...
        if (vrMicBtn) vrMicBtn.classList.add('text-red-500'); 
    };
