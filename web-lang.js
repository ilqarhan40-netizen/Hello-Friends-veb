window.i18n = { 
    ...
    az: { nav_chat: "Çat", nav_voice: "Səsli Çat", nav_conf: "Konfrans", nav_prof: "Peşələr", nav_contacts: "Əlaqələr", nav_archive: "Arxiv", search_ph: "Axtarış...", global_chat: "Qlobal Çat", welcome_title: "Hello Friends-ə Xoş Gəlmisiniz!", global_network: "Qlobal Smart Şəbəkə", creator_badge: "Hello Friends Yaradıcısı", menu: "Ayarlar", profile: "Profil", my_profile: "Mənim Profilim", complete_reg: "Qeydiyyatı Tamamla", full_name: "Tam Ad", wallet: "Pulqabı", email_store: "E-poçt Mağazası", theme: "Mövzunu Dəyiş", logout: "Çıxış", action_chat: "Şəxsi Çat", action_voice: "Səsli Otaq", action_video: "Video Konfrans", action_email: "E-poçt Göndər", action_cellular: "Mobil Zəng", cv_prof: "Peşə", cv_langs: "DİLLƏR", country: "Ölkə", cv_country: "Ölkə", phone: "Telefon Nömrəsi", cv_phone_header: "İŞ TELEFONU", email: "E-poçt Ünvanı", cv_email_header: "İŞ E-POÇTU", cv_exp: "TƏCRÜBƏ", cv_edu: "TƏHSİL", skills: "ƏSAS BACARIQLAR", cv_about: "HAQQIMDA", edit_cv: "CV-ni Redaktə Et", view_cv: "CV-yə Bax", edit_pro_cv: "Peşəkar CV", cv_role: "Əsas Rol", save_cv: "Yadda Saxla", save_profile: "Profili Yadda Saxla", select_room_lang: "Otaq Dili", cancel: "Ləğv Et", population: "Əhali", seas: "Dənizlər", chat: "Çat", sms: "SMS", email_btn: "E-poçt", purchase: "İndi Al" },
    kk: { nav_chat: "Чат", nav_voice: "Дауыстық чат", nav_conf: "Конференция", nav_prof: "Мамандық", nav_contacts: "Контактілер", nav_archive: "Мұрағат", search_ph: "Іздеу...", global_chat: "Глобалды чат", welcome_title: "Hello Friends-ке қош келдіңіз!", global_network: "Ғаламдық смарт-желі", creator_badge: "Hello Friends құрушысы", menu: "Баптаулар", profile: "Профиль", my_profile: "Менің профилім", complete_reg: "Тіркелуді аяқтау", full_name: "Толық аты-жөні", wallet: "Әмиян", email_store: "Пошта дүкені", theme: "Тақырыпты өзгерту", logout: "Шығу", action_chat: "Жеке чат", action_voice: "Дауыстық бөлме", action_video: "Бейнеқоңырау", action_email: "Хат жіберу", action_cellular: "Телефон соғу", cv_prof: "Мамандық", cv_langs: "ТІЛДЕР", country: "Ел", cv_country: "Ел", phone: "Телефон нөмірі", cv_phone_header: "ЖҰМЫС ТЕЛЕФОНЫ", email: "Электрондық пошта", cv_email_header: "ЖҰМЫС ПОШТАСЫ", cv_exp: "ТӘЖІРИБЕ", cv_edu: "БІЛІМ", skills: "НЕГІЗГІ ДАҒДЫЛАР", cv_about: "ӨЗІМ ТУРАЛЫ", edit_cv: "Түйіндемені өңдеу", view_cv: "Түйіндемені көру", edit_pro_cv: "Кәсіби түйіндеме", cv_role: "Негізгі рөл", save_cv: "Түйіндемені сақтау", save_profile: "Профильді сақтау", select_room_lang: "Бөлме тілі", cancel: "Бас тарту", population: "Халық саны", seas: "Теңіздер", chat: "Чат", sms: "SMS", email_btn: "Пошта", purchase: "Сатып алу" }
};
...
window.getSmartLang = function(userProfile) {
    ...
    if (phone.startsWith('+7')) {
        // Если флаг kz, то казахский, иначе русский
        if(flag === 'kz') return 'kk';
        return 'ru';
    }
    if (phone.startsWith('+994')) return 'az';
    if (phone.startsWith('+49')) return 'de';
    
    const flagToLang = { 'ru': 'ru', 'az': 'az', 'de': 'de', 'gb': 'en', 'us': 'en', 'kz': 'kk' };
...
// ==========================================
// ЛОГИКА "ЯЗЫК ЧАТА" (С КАЗАХСКИМ ЯЗЫКОМ)
// ==========================================
    ...
    <div id="chat-lang-modal" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-[10000] transition-opacity" onclick="if(event.target===this) window.closeChatLangModal()">
        <div class="bg-[#1a2235] w-[340px] rounded-3xl p-6 relative flex flex-col shadow-[0_0_40px_rgba(0,0,0,0.8)] border border-white/5" onclick="event.stopPropagation()">
            ...
            <div class="flex flex-col gap-2 overflow-y-auto max-h-[50vh] pr-1 custom-scrollbar">
                ...
                <button onclick="window.setChatLang('kk')" class="w-full py-3 px-4 bg-transparent border border-white/10 rounded-xl font-bold text-sm flex items-center gap-3 transition hover:bg-white/5 text-white"><span class="text-gray-400 font-black w-6 text-center">KZ</span> Қазақша</button>
